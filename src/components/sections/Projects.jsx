            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition ">
                        ...
                        <p className="text-gray-400 mb-3">
                           This Snake Game was created using Python and the Pygame library in Visual Studio Code.
                           The player controls a snake that grows longer by eating randomly spawning food.
                           The game tracks the score and ends if the snake collides with itself or the wall.
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition ">
                        ...
                        <p className="text-gray-400 mb-3">
                           This AI Assistant was developed using Python and machine learning libraries in Visual Studio Code.
                           It can understand and generate human-like text based on user input, similar to how ChatGPT works.
                           The assistant handles tasks like answering questions, generating content, and holding conversations.
                           Its design includes a modular structure with components for natural language processing, intent recognition, and response generation.
                         </p>
                         <div className="flex flex-wrap gap-2 mb-4">
                            {["React", "Node.js", "Javascript", "HTML"].map((tech, key) => (
                                <span
